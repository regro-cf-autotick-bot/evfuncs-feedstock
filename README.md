...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/evfuncs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14914&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/evfuncs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `evfuncs` can be installed with:

```
conda install evfuncs
```

It is possible to list all of the versions of `evfuncs` available on your platform with:
